...
%	Paragraph 5 - short segue/ signposting
	...
	\info{850 words, reduce in revisions}
		...
		Chitin macrofibers are orthotropic (axial: $E_1~=~8.5\,\text{GPa}$, transverse: $ E_2~=~E_3~=~0.52\,\text{GPa}$ \cite{Jansen2016}) and arranged in unidirectional plies, as in Figs. \info{~INSERT-FIGS-HERE} \cite{Kamp2010,Kamp2015}.
