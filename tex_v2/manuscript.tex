...
%	Paragraph 5 - short segue/ signposting
	...
	\section{Microstructure of the \textit{Curculio} rostrum}
		...
		Beetle endocuticle, however, is unique among arthropods and is comprised of large (5-20\,{\textmu}m OD) unidirectional bundles of chitin, called macrofibers.
		Chitin macrofibers are orthotropic ($E_1 = 8.5$\,GPa, $E_2 = E_3 = 0.52$\,GPa \cite{Jansen2016}) and arranged in unidirectional plies, as in Figs. \info{~INSERT-FIGS-HERE} \cite{Kamp2010,Kamp2015}.
	...
	\section{Load cycling of \textit{Curculio caryae}}
		...
		The endocuticle is made of aligned \textalpha-chitin nanofibrils whose crystaline structure is enforced by hydrogen bonds between individual chitin chains along their length.
