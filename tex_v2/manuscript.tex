...
%Intro - 670 words, reduce to 500 or so
	...
	%590 words... still must add numbers...
	...
	\section{Conclusions}
	%word count: (3157 so far...)
	%Par 1 - Microstructure
	%Par 2 - Tensile and fatigue
	%Par 3 - Fracture
	%Par 4 - Wrap-up
		...
		Constitutive models demonstrated that an idealized apical cuticle could theoretically achieve 72\% and 60\% reductions in the effective longitudinal membrane and flexural moduli, respectively, compared to the cuticle of the head capsule, thus accounting for the observed flexibility of the rostral apex in live specimens. However, these reductions could only be realized with both modifications to the cuticle, which have a non-additive effect on cuticle elasticity.
		Tensile testing data revealed that increased endocuticle thickness enhances the fracture toughness of the cuticle, raising the intriguing possibility that this system evolved via negative selection of breakage, rather than positive selection of flexibility.
		
		We confirmed that altered composite profile of the cuticle in the rostral apex makes the rostrum simultaneously more flexible and fracture resistant, and .
		
		Based on fractographic analysis of test-specimens, we infer that the endocuticle deforms viscoelastically along the longitudinal axes of the macrofibers under uniaxial tension, causing ply-splitting and delamination at high strain.
		The overlying exocuticle then exhibits brittle fracture, at a comparatively low strain, due to shearing between the stretching endocuticle fibers to which it is anchored.
		...
		To the best of our knowledge... had not previously been reported
