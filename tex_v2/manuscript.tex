...
%Intro - 670 words, reduce to 500 or so
	...
	\info{780 words, reduce in revisions}
		...
		However, we have also found that the cuticle composite lay-up of the rostral apex differs from that of the head capsule (see Fig.\info{~INSERT-REFS-HER}) in two key characteristics:
	...
	%600 words... still must add numbers...
		...
		Heads of female specimens of each species were rehydrated by immersion in de-ionized water for 24 hours
		Each specimen was subjected to force-controlled, uniaxial loading to fracture at a constant stress rate (detailed in Methods).
		...
		We observed that the maximum force sustained at the site of the break was strongly correlated with the cross-sectional area of the endocuticle, and not the exocuticle, at that site.
		...
		Inversely, the failure strength of the cuticle is positively associated with the relative proportion of the endocuticle.
		
		Although CLPT predicts that the proportion of exocuticle is positively correlated with the stiffness of generalized cuticle, we found no associations between the cross-sectional properties of the fracture site and the gross behavior of the entire rostrum.
		...
		From these results, we infer that the gross elastic behavior of the cuticle is consistent across the genus, in agreement with our current understanding of cuticle mechanobiology.
		It is therefore unlikely that differences in sclerotization or chitin composition within the cuticle, rather than composite profile, are responsible for the mechanical behavior of the rostrum in different species.
		Furthermore, the endocuticle apparently contributes more to the tensile strength of the rostrum than the exocuticle, likely because the endocuticle is organized in large bundles of aligned, anisotropic fibers.
		Thus, the altered composite profile of the cuticle in the rostral apex makes the rostrum simultaneously more flexible and fracture resistant.
	...
	%currently ~650 words
		Due to the complex failure patterns present across the fracture surface, it was not always possible to identify void nucleation and crack initiation sites (both primary and secondary).
		...
		Scanning electron and light microscopy of testing specimens revealed that the fracture mechanics of the exocuticle and endocuticle differed according to their microstructure.	
		In transverse view, the exocuticle consistently presented a nearly continuous fracture surface, indicative of comparatively brittle failure, likely due to the helicoidal arrangement of \textalpha-chitin laminae and resultant transverse isotropy of the Bouligand structure.
		The exocuticle typically appeared to fracture at lower strains than the endocuticle, with shear-cusp formation evident across the fracture surface and over unbroken endocuticle on the rostral surface adjacent to the plane of fracture.
		Conversely, the endocuticle exhibited severe delamination, off-axis ply-splitting, and fiber-pulling away from the fracture surface, indicating that endocuticular macrofibers are less brittle than the exocuticle due to the unidirectional alignment of their \textalpha-chitin fibers.
		...
		These sulci increase the volume fraction of exocuticle in the ventral part of the snout and create large interfaces ideal for void nucleation.
		...
		Thus, contralateral fibers in the same lamina displayed opposing fracture modes.
		...
		Dorsally, the coalescent crack fronts often caused significant de-bonding and ply-splitting followed by broom-like tensile failure; in some specimens, the contralateral crack fronts were out of plane and coalesced via transverse shearing through a large dorsal section of cuticle.
		...
		Although other, more complex failure modes have been observed, we posit that in live specimens this is the most likely mechanism of tensile failure because typical bending behavior generates tension along the ventral surface of the rostrum.

	\section{Conclusions}
	%1-2 'short paragraphs', 300 words maximum, already at 3200...
		In this study, we...
		raising the intriguing possibility that this system evolved via negative selection of breakage, rather than positive selection of flexibility.\info{(maybe say this in conclusions)}
		 
		evolutionary constraint (like occipital sulci)
		 
		The macrofibers are pulled longitudinal axis, explains fmax, toughness, and upcurved stress-strain curve.
		 
		 
		 
		We therefore infer that, under uniaxial tension, the endocuticle deforms viscoelastically along the longitudinal axes of the macrofibers, causing ply-splitting and delamination at high strain, while the overlying exocuticle exhibits brittle fracture, at a comparatively low strain, due to shearing between the stretching endocuticle fibers to which it is anchored.
